import { ViewChild, ElementRef, Input, Output, Component, ViewEncapsulation, ChangeDetectionStrategy, Renderer2, EventEmitter, NgModule } from '@angular/core';
...
var Select2Component = /** @class */ (function () {
    ...
    Select2Component.prototype.ngOnInit = function () {
        if (this.cssImport) {
            ...
            if (!link.version) {
                var newLink = this.renderer.createElement(head.outerHTML, 'style');
                this.renderer.setStyle(newLink, 'type', 'text/css');
                this.renderer.setStyle(newLink, 'version', 'select2');
                this.renderer.setStyle(newLink, 'innerHTML', this.style);
            }
        }
    };
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (changes['disabled'] && changes['disabled'].previousValue !== changes['disabled'].currentValue) {
                            this.renderer.setStyle(this.selector.nativeElement, 'disabled', this.disabled);
                        }
                        return [2 /*return*/];
                }
            });
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.element.hasClass('select2-hidden-accessible') == true) {
                            ...
                            this.renderer.setStyle(this.selector.nativeElement, 'innerHTML', '');
                        }
                        options = {
                            data: this.data,
        ...
        if (Array.isArray(newValue)) {
            for (var _i = 0, _a = this.selector.nativeElement.options; _i < _a.length; _i++) {
                ...
                if (newValue.indexOf(option.value) > -1) {
                    this.renderer.setStyle(option, 'selected', 'true');
                }
            }
        }
        else {
            this.renderer.setStyle(this.selector.nativeElement, 'value', newValue);
        }
...
export { Select2Component, Select2Module };
